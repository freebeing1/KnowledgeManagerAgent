...
public class MessageService {
	...
	public void send(LTMMessage message){
		System.out.println("[LTM Message]\t<"+message.getAction().toString()+">\t"+message.getClient()+" : "+message.getContent());
	...
	public void messageRecieved(LTMMessage ltmMessage) {
		System.out.println("[LTM Message]\t<"+ltmMessage.getAction().toString()+">\t"+ltmMessage.getClient()+" : "+ltmMessage.getContent());
